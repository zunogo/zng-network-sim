...
class StationConfig(BaseModel):
    ...
    grid_connection_cost: float = Field(default=1_000_000.0, ge=0, le=2_000_000.0, description="Transformer, cabling (₹)")
    ...
    docks_per_station: int = Field(default=75, ge=1, le=10_000, description="Charger slots per station")
