...
class StationConfig(BaseModel):
    ...
    grid_connection_cost: float = Field(default=500_000.0, ge=0, description="Transformer, cabling (₹)")
    ...
    docks_per_station: int = Field(default=50, ge=1, description="Charger slots per station")
